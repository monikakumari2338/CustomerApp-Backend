...
public interface ProductService {
    ...
    List<Product> getTopCategoryWise(String category);
    ...
    List<Product>filterProductBasedOnMultiFilter(String category, List<String> brand, List<String> color, List<String> seller);
