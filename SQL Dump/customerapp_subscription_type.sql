...
CREATE TABLE `subscription_type` (
  ...
  `delivery_days` varbinary(255) DEFAULT NULL,
  `delivery_time` time DEFAULT NULL,
  `end_date` date DEFAULT NULL,
  `paused` bit(1) DEFAULT NULL,
  `start_date` date DEFAULT NULL,
  `type` smallint DEFAULT NULL,
  `product_id` bigint DEFAULT NULL,
  `user_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKh5exy290hqx4scbwhp7tn0try` (`product_id`),
  KEY `FK57hc0oykip5r8ata9j5cfxt8c` (`user_id`),
  CONSTRAINT `FK57hc0oykip5r8ata9j5cfxt8c` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  CONSTRAINT `FKh5exy290hqx4scbwhp7tn0try` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`)
...
-- Dump completed on 2024-12-10 18:07:48
