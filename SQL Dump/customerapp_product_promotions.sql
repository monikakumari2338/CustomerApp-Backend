...
CREATE TABLE `product_promotions` (
  ...
  KEY `FKqmcm2exr3u4h8gxekpru47vqb` (`promotion_id`),
  KEY `FKk62rx1nxvu2sfsf6thcge8uvu` (`product_id`),
  CONSTRAINT `FKk62rx1nxvu2sfsf6thcge8uvu` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`),
  CONSTRAINT `FKqmcm2exr3u4h8gxekpru47vqb` FOREIGN KEY (`promotion_id`) REFERENCES `promotions` (`id`)
...
INSERT INTO `product_promotions` VALUES (452,3),(453,1),(453,4),(454,5);
