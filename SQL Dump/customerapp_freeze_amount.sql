...
CREATE TABLE `freeze_amount` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK86v6liuqxoguqoarpnucor8xb` (`subscription_id`),
  KEY `FKesv1m2l2jm3voirbk3c1i8mot` (`user_id`),
  CONSTRAINT `FK86v6liuqxoguqoarpnucor8xb` FOREIGN KEY (`subscription_id`) REFERENCES `subscription_type` (`id`),
  CONSTRAINT `FKesv1m2l2jm3voirbk3c1i8mot` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
...
-- Dump completed on 2025-01-08 12:44:00
